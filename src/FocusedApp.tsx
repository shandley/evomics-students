      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-primary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col justify-center items-center h-64 gap-4">
            ...
            <div className="text-gray-700 font-medium">Loading student data...</div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-primary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col justify-center items-center h-64 gap-4">
            ...
            <div className="text-gray-700 font-medium">Error: {error}</div>
          </div>
        </div>
      </div>
    );
          ...
          <div className="flex justify-between items-start">
            <div className="animate-fade-in">
              ...
              <p className="text-primary-100 mt-2 text-lg">
                Celebrating the global community of students who have shaped genomics education worldwide, taught by our{' '}
                <a 
